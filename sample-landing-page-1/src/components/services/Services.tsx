...
const Services = () => {
  ...
  return (
    <div
      ...
      className="pt-24 pb-32 px-4 sm:px-10 md:px-60 lg:px-16 xl:px-36 2xl:px-72"
    >
      ...
      <div id="services-opinion" className="lg:flex justify-center items-center lg:px-12">
